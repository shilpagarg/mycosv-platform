...
COLUMN_ALIASES: Dict[str, Sequence[str]] = {
    "sample": ["sample", "sample_id", "tumor_sample", "specimen", "case"],
    "dataset": ["dataset", "dataset_name", "cohort", "group"],
    "caller": ["caller", "tool", "method", "sv_caller"],
    "sv_type": ["sv_type", "type", "svclass", "sv_class", "event_type"],
    "chrom": ["chrom", "chr", "chromosome"],
    "start": ["start", "pos", "position", "breakpoint1", "bp1"],
    "end": ["end", "stop", "breakpoint2", "bp2"],
    "sv_len": ["sv_len", "length", "size", "event_size", "span"],
    ...
    "breakpoint_error": ["breakpoint_error", "bp_error", "distance_to_truth"],
    "support": ["support", "read_support", "split_read_support", "evidence"],
    ...
    "phenotype": ["phenotype", "status", "group", "response", "subtype"],
    "expression": ["expression", "expr", "log2_expression", "gene_expression"],
    "cn": ["cn", "copy_number", "copy_number_state"],
}
